                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('') }}assets/images/svg/crypto-icons/etc.svg"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('') }}assets/images/svg/crypto-icons/bnb.svg"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('') }}assets/images/svg/crypto-icons/usdt.svg"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('') }}assets/images/svg/crypto-icons/neo.svg"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ asset('') }}assets/images/svg/crypto-icons/doge.svg"
                                                    alt="" class="avatar-xxs">
                                            </div>
                                            <div>
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush border-dashed mb-0">
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('') }}assets/images/svg/crypto-icons/btc.svg" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('') }}assets/images/svg/crypto-icons/eth.svg" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('') }}assets/images/svg/crypto-icons/aave.svg" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('') }}assets/images/svg/crypto-icons/doge.svg" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('') }}assets/images/svg/crypto-icons/bnb.svg" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('') }}assets/images/svg/crypto-icons/ltc.svg" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        <div class="flex-shrink-0">
                            <img src="{{ asset('') }}assets/images/small/img-1.jpg" class="rounded img-fluid"
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ asset('') }}assets/images/small/img-2.jpg" class="rounded img-fluid"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ asset('') }}assets/images/small/img-3.jpg" class="rounded img-fluid"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ asset('') }}assets/images/small/img-6.jpg" class="rounded img-fluid"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
