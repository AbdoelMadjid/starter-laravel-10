                    ...
                    <div class="table-responsive table-card">
                        <div data-simplebar style="max-height: 365px;">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('') }}assets/images/nft/img-04.jpg" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-1">
                        <p class="mb-1"><img src="{{ asset('') }}assets/images/flags/us.svg" alt=""
                                height="15" class="rounded me-2"> United States <span class="float-end">34%</span></p>
                        <p class="mb-1"><img src="{{ asset('') }}assets/images/flags/russia.svg" alt=""
                                height="15" class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                        <p class="mb-1"><img src="{{ asset('') }}assets/images/flags/spain.svg" alt=""
                                height="15" class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                        <p class="mb-1"><img src="{{ asset('') }}assets/images/flags/italy.svg" alt=""
                                height="15" class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                        <p class="mb-0"><img src="{{ asset('') }}assets/images/flags/germany.svg" alt=""
