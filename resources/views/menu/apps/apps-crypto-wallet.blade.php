                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('') }}assets/images/svg/crypto-icons/mkr.svg"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ asset('') }}assets/images/svg/crypto-icons/aave.svg"
                                                alt="" class="avatar-xxs me-2" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ asset('') }}assets/images/svg/crypto-icons/yfi.svg"
                                                alt="" class="avatar-xxs me-2" />
