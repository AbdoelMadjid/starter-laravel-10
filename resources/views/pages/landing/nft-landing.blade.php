...
<!-- Mirrored from themesbrand.com/velzon/html/default/nft-landing by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2024 12:19:25 GMT -->
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="{{ asset('') }}assets/images/nft/wallet/binance.png" alt=""
                                    height="55" class="mb-3 pb-2">
                                <h5>Binance</h5>
                ...
                <div class="row">
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{ asset('') }}assets/images/nft/img-03.jpg" alt=""
                    ...
                    <div class="col-lg-4 product-item music crypto-card games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{ asset('') }}assets/images/nft/img-02.jpg" alt=""
                                    class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i
                    ...
                    <div class="col-lg-4 product-item artwork music games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{ asset('') }}assets/images/img-4.gif" alt=""
                                    class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i
                    ...
                    <div class="col-lg-4 product-item crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{ asset('') }}assets/images/nft/img-01.jpg" alt=""
                                    class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{ asset('') }}assets/images/nft/img-05.jpg" alt=""
                                    class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{ asset('') }}assets/images/nft/img-06.jpg" alt=""
                                    class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{ asset('') }}assets/images/nft/wallet.png" alt=""
                                    class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{ asset('') }}assets/images/nft/money.png" alt=""
                                    class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{ asset('') }}assets/images/nft/add.png" alt=""
                                    class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{ asset('') }}assets/images/nft/sell.png" alt=""
                                    class="avatar-sm">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    ...
                                                    <img src="{{ asset('') }}assets/images/img-2.gif"
                                                        alt="" class="img-fluid rounded mt-1">
                                                </div><!--end col-->
                                                <div class="col-6">
                                                    <img src="{{ asset('') }}assets/images/img-5.gif"
                                            ...
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="{{ asset('') }}assets/images/nft/img-05.jpg"
                                                        alt="" class="img-fluid rounded">
                                                    <img src="{{ asset('') }}assets/images/img-1.gif"
                                                        alt="" class="img-fluid rounded mt-1">
                                                </div><!--end col-->
                                                <div class="col-6">
                                                    <img src="{{ asset('') }}assets/images/img-4.gif"
                                                        alt="" class="img-fluid rounded mb-1">
                                            ...
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="{{ asset('') }}assets/images/nft/img-02.jpg"
                                                        alt="" class="img-fluid rounded">
                                                    <img src="{{ asset('') }}assets/images/img-3.gif"
                                                        alt="" class="img-fluid rounded mt-1">
                                                </div><!--end col-->
                                                <div class="col-6">
                                                    <img src="{{ asset('') }}assets/images/img-1.gif"
                    ...
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="{{ asset('') }}assets/images/img-1.gif" alt=""
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="{{ asset('') }}assets/images/img-5.gif" alt=""
                                            class="avatar-sm object-fit-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="pages-profile">
                            ...
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        ...
                                        <li><a href="apps-crm-contacts">Contact</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/nft-landing by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2024 12:19:26 GMT -->
