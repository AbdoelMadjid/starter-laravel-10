...
<!-- Mirrored from themesbrand.com/velzon/html/default/job-landing by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2024 12:19:26 GMT -->
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="position-relative home-img text-center mt-5 mt-lg-0">
                            ...
                            <img src="{{ asset('') }}assets/images/job-profile2.png" alt=""
                                class="user-img">
                                ...
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-success-subtle rounded">
                                            <img src="{{ asset('') }}assets/images/companies/img-9.png"
                                                alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-success-subtle rounded">
                                            <img src="{{ asset('') }}assets/images/companies/img-7.png"
                                                alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                ...
                <div class="row align-items-center gy-4">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="text-muted mt-5 mt-lg-0">
                            ...
                            <div class="mt-4">
                                <a href="apps-job-companies-lists" class="btn btn-primary">View More Companies <i
...
<!-- Mirrored from themesbrand.com/velzon/html/default/job-landing by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2024 12:19:27 GMT -->
