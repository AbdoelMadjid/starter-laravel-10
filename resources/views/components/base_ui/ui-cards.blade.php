            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="{{ asset('') }}assets/images/small/img-8.jpg"
                            alt="Card image cap">
                        <div class="card-footer">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="{{ asset('') }}assets/images/small/img-10.jpg"
                            alt="Card image cap">
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-fit-cover"
                                    src="{{ asset('') }}assets/images/small/img-12.jpg" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-fit-cover"
                                    src="{{ asset('') }}assets/images/small/img-4.jpg" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-fit-cover"
                                    src="{{ asset('') }}assets/images/small/img-9.jpg" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-fit-cover"
                                    src="{{ asset('') }}assets/images/small/img-2.jpg" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
    ...
    <div class="row g-3">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                ...
                <img class="img-fluid" src="{{ asset('') }}assets/images/small/img-11.jpg" alt="Card image cap" />
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="{{ asset('') }}assets/images/small/img-7.jpg" class="card-img" alt="..." />
                    </div>
                </div><!-- end col -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card p-3">
